...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("temperature", "0.6", env_key="BBM_TEMPERATURE", translator_flag="--temperature"),
    ...
    SettingDefinition("glossary", "", env_key="BBM_GLOSSARY"),
    ...
    SettingDefinition("translate_tags", "p,h1", env_key="BBM_TRANSLATE_TAGS", translator_flag="--translate-tags"),
    SettingDefinition(
