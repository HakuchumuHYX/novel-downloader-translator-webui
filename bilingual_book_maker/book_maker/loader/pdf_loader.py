...
class PDFBookLoader(BaseBookLoader):
    ...
    def _try_create_epub(self):
        ...
        try:
            ...
            out_path = f"{Path(self.pdf_name).parent}/{Path(self.pdf_name).stem}_翻译.epub"
    ...
    def make_bilingual_book(self):
        ...
        try:
            ...
            txt_out = (
                f"{Path(self.pdf_name).parent}/{Path(self.pdf_name).stem}_翻译.txt"
            )
            ...
            if epub_ok:
                print(f"created epub: {Path(self.pdf_name).stem}_翻译.epub")
            else:
                print(
